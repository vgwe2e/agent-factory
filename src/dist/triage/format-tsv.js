...
export const TSV_HEADERS = "tier\taction\tl1_name\tl2_name\tl3_name\tcombined_max_value\tquick_win\tlead_archetype\tl4_count\tred_flags";
/**
 ...
 * - No trailing newline.
 */
export function formatTriageTsv(results) {
