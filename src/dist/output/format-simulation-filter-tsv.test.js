...
describe("formatSimulationFilterTsv", () => {
    ...
    it("uses skill_name and l4_name headers in two-pass mode", () => {
        const tsv = formatSimulationFilterTsv([makeScoring({ l4Name: "Advance Opp", skillName: "Forward Opportunity Name", skillId: "cf-advance", l1Name: "Cross-Functional" })], makeSimResults(), "two-pass");
