...
export function formatImplementationShortlistTsv(scored, simResults, verdicts, scoringMode) {
    ...
    const rows = simResults.results
        ...
        .sort((a, b) => {
        const readinessDelta = (b.assessment?.implementationReadinessScore ?? 0) -
