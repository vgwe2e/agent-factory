...
describe("formatImplementationShortlistTsv", () => {
    ...
    it("uses skill_name and l4_name headers in two-pass mode", () => {
        const tsv = formatImplementationShortlistTsv([makeScoring({ skillId: "cf-test", l1Name: "Cross-Functional", l4Name: "Advance Opp", l3Name: "Parent Opp" })], makeSimResults(), ["ADVANCE"], "two-pass");
