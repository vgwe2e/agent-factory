...
describe("spearmanRho", () => {
    ...
    it("throws on mismatched array lengths", () => {
        assert.throws(() => spearmanRho([1, 2], [1, 2, 3]), { message: "Arrays must have equal length" });
    });
    it("throws on fewer than 2 observations", () => {
        assert.throws(() => spearmanRho([1], [2]), { message: "Need at least 2 paired observations" });
    });
    it("throws on empty arrays", () => {
        assert.throws(() => spearmanRho([], []), { message: "Need at least 2 paired observations" });
    });
