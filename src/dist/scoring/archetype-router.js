...
const VALID_ARCHETYPES = ["DETERMINISTIC", "AGENTIC", "GENERATIVE"];
/**
 ...
 */
export function classifyArchetype(opp, l4s) {
    ...
    let inferred = "DETERMINISTIC"; // safe default
    if (l4s.length > 0) {
