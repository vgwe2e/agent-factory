 ...
 */
import { scoreFinancialSignal, scoreAiSuitability, scoreDecisionDensity, scoreImpactOrder, scoreRatingConfidence, scoreArchetypeCompleteness, } from "./dimensions.js";
 ...
 */
export function preScoreAll(hierarchy, topN) {
    const scored = [];
