...
function rankComparator(a, b) {
    ...
    if (b.aggregatedMaxValue !== a.aggregatedMaxValue)
        return b.aggregatedMaxValue - a.aggregatedMaxValue;
 ...
 */
export function filterTopN(scored, topN) {
