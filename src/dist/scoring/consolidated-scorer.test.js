...
import { computeTwoPassComposite, scaleTo03, scoreConsolidated, DISAGREE_PENALTY, PARTIAL_PENALTY, PRE_SCORE_WEIGHT, LLM_WEIGHT, buildTechnicalLensFromLLM, buildAdoptionLensFromDeterministic, buildValueLensFromDeterministic, } from "./consolidated-scorer.js";
// -- Helpers --
...
function makeMockChatFn(response) {
    return async () => ({
        success: true,
