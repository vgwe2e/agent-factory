...
const ARCHETYPE_EMPHASIS: Record<LeadArchetype, string> = {
  DETERMINISTIC:
    "This is a DETERMINISTIC archetype skill. Weight 'decision_density' highest. " +
  ...
  AGENTIC:
    "This is an AGENTIC archetype skill. Weight 'confidence_signal' highest. " +
  ...
  GENERATIVE:
    "This is a GENERATIVE archetype skill. Weight 'impact_proximity' highest. " +
