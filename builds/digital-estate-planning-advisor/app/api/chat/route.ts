...
import * as analyzeDigitalEstate from '@/lib/tools/analyze-digital-estate'
import * as searchPlatformPolicies from '@/lib/tools/search-platform-policies'
import * as searchEstateLaws from '@/lib/tools/search-estate-laws'
import * as writeEstatePlan from '@/lib/tools/write-estate-plan'

let toolsRegistered = false
function ensureTools() {
  if (toolsRegistered) return
  registerTool(analyzeDigitalEstate)
  registerTool(searchPlatformPolicies)
  registerTool(searchEstateLaws)
  registerTool(writeEstatePlan)
