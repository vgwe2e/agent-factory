...
import * as searchComparableSales from '@/lib/tools/search-comparable-sales'
import * as analyzeAssessment from '@/lib/tools/analyze-assessment'
import * as writeAppealReport from '@/lib/tools/write-appeal-report'
...
function ensureTools() {
  ...
  registerTool(searchComparableSales)
  registerTool(analyzeAssessment)
  registerTool(writeAppealReport)
