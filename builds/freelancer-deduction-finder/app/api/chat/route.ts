...
import * as searchDeductions from '@/lib/tools/search-deductions'
import * as analyzeExpenses from '@/lib/tools/analyze-expenses'
import * as writeDeductionReport from '@/lib/tools/write-deduction-report'
...
function ensureTools() {
  ...
  registerTool(searchDeductions)
  registerTool(analyzeExpenses)
  registerTool(writeDeductionReport)
