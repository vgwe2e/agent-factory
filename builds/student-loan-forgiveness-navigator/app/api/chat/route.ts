...
import * as analyzeLoanSituation from '@/lib/tools/analyze-loan-situation'
import * as searchForgivenessPrograms from '@/lib/tools/search-forgiveness-programs'
import * as checkRepaymentOptions from '@/lib/tools/check-repayment-options'
import * as writeForgivenessGuide from '@/lib/tools/write-forgiveness-guide'

let toolsRegistered = false
function ensureTools() {
  if (toolsRegistered) return
  registerTool(analyzeLoanSituation)
  registerTool(searchForgivenessPrograms)
  registerTool(checkRepaymentOptions)
  registerTool(writeForgivenessGuide)
